package com.finoana.arith.unit;
...
import com.finoana.arith.conf.FacadeIT;
import com.finoana.arith.endpoint.event.consumer.model.ConsumableEvent;
import com.finoana.arith.endpoint.event.consumer.model.ConsumableEventTyper;
import com.finoana.arith.endpoint.event.consumer.model.TypedEvent;
import com.finoana.arith.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.finoana.arith.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.finoana.arith.endpoint.event.model.UuidCreated", payload);
